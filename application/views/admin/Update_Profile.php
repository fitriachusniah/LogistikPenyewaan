...
<div class="main-content-wrap d-flex flex-column">
	<div class="main-content">
		...
		<div class="row mb-4">
			<div class="col-md-12">
				<a class="btn btn-primary btn-rounded" href="<?= base_url()?>admin/Dashboard/?>">
		...
		<div class="row">
			<div class="col-md-12 mb-4">
				<div class="card text-left">
					<div class="card-body">
						<form action="<?= $edit_action ?>/<?php echo $this->session->userdata('user_id') ?>" method="post" enctype="multipart/form-data">
